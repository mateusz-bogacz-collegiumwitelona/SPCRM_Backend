...
{
    [Mapper]
    public partial class PromotionMapper : BaseMapper
    {
        ...
        [MapProperty(nameof(EditPromotionRequest.Name), nameof(EditPromotionCommand.Name), Use = nameof(NormalizeNullableName))]
