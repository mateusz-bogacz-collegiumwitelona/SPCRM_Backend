...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260918183310_addInvociePayment")]
    partial class addInvociePayment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Common.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Models.CompanyAdress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Models.DealProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Models.InvoicePayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Models.InvoiceProducts", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Models.OfferProducts", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Models.Promotion", b =>
                {
                    ...
                    b.Property<long?>("PromotionalPrice")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Models.SteelGrade", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Models.ContactNote", b =>
                {
                    b.HasBaseType("Domain.Common.Note");
            ...
            modelBuilder.Entity("Domain.Models.DealNote", b =>
                {
                    b.HasBaseType("Domain.Common.Note");
            ...
            modelBuilder.Entity("Domain.Models.TaskNote", b =>
                {
                    b.HasBaseType("Domain.Common.Note");
            ...
            modelBuilder.Entity("Domain.Models.DealProduct", b =>
                {
                    b.HasOne("Domain.Models.Deal", "Deal")
            ...
            modelBuilder.Entity("Domain.Models.Product", b =>
                {
                    ...
                    b.HasOne("Domain.Models.SteelGrade", "SteelGrade")
                        .WithMany("Products")
                        .HasForeignKey("SteelGradeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Models.UnitOfMeasure", "Unit")
                        .WithMany("Products")
