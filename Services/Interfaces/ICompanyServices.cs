...
namespace Services.Interfaces
{
    ...
    {
        Task<Result<List<CompaniesMapResponse>>> GetMapAsync(string? searchTerm = null);
        Task<Result<CompanyDetailResponse>> GetCompanyDetailsAsync(Guid id, Guid userId);
        Task<Result<PagedResult<AddressDetailResponse>>> GetCompanyAddressesAsync(CompanyCommand command);
        ...
        Task<Result<EditCompanyDetailResponse>> GetEditCompanyDetailAsync(Guid id);
    }
}
